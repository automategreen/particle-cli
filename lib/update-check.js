...
function displayVersionBanner(version) {
	console.error('automategreen-cli v' + info.version);
	console.error();
	console.error(chalk.yellow('!'), 'A newer version (' + chalk.cyan(version) + ') of', chalk.bold.white('automategreen-cli'), 'is available.');
	console.error(chalk.yellow('!'), 'Upgrade now by running:', chalk.bold.white('npm install -g automategreen-cli'));
	console.error();
}
